...
- [x] 同じ課金設計書に残る`llm_usage`分析前提を`device_monthly_usage`/`ruling_job`へ、deviceId永続化前提をD-005のインストール単位ID・RevenueCat購入復元へ更新する → **2026-09-02完了**
- [x] プライバシーポリシーとGoogle Play Data SafetyドラフトにRevenueCat、購読状態、購入処理で扱うデータと利用目的を追記する → **2026-09-02完了**(`docs/mobile-app-privacy-policy.html`・`mobile_app/store_listing/data_safety_and_checklist.md`両方更新)
